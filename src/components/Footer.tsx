...
export default function Footer() {
  return (
    <footer className="relative mt-12 md:mt-20 pt-16 md:pt-20 pb-8 md:pb-10 px-4 sm:px-6 overflow-hidden">
      {/* Decorative Glows */}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 lg:gap-20 mb-16 md:mb-20">
          <div className="flex flex-col gap-4 md:gap-6 text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start gap-3">
              ...
              <span className="text-2xl md:text-3xl font-black font-display tracking-tighter text-white">
                আমার <span className="text-neon-blue">দোকান</span>
              </span>
            </div>
            <p className="text-white/40 text-base md:text-lg leading-relaxed font-medium px-4 sm:px-0">
            ...
            <div className="flex justify-center sm:justify-start gap-3 md:gap-4 mt-2">
              <motion.a 
                ...
                className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-white/5 rounded-xl md:rounded-2xl text-white/40 border border-white/10 transition-colors"
              >
          ...
          <div className="hidden sm:block">
            <h4 className="text-white font-black uppercase tracking-[0.2em] text-[10px] md:text-xs mb-6 md:mb-8">কোম্পানি</h4>
            <ul className="flex flex-col gap-3 md:gap-4">
              {["আমাদের গল্প", "ক্যারিয়ার", "ব্লগ", "প্রাইভেসি পলিসি", "শর্তাবলী"].map(item => (
                <li key={item}>
                  <a href="#" className="text-white/40 font-bold hover:text-neon-blue transition-colors flex items-center group text-sm md:text-base">
          ...
          <div className="hidden sm:block">
            <h4 className="text-white font-black uppercase tracking-[0.2em] text-[10px] md:text-xs mb-6 md:mb-8">সহায়তা</h4>
            <ul className="flex flex-col gap-3 md:gap-4">
              {["ডেলিভারি তথ্য", "রিটার্ন পলিসি", "অর্ডার ট্র্যাকিং", "পেমেন্ট মেথড", "হেল্প সেন্টার"].map(item => (
                <li key={item}>
                  <a href="#" className="text-white/40 font-bold hover:text-neon-purple transition-colors flex items-center group text-sm md:text-base">
                    <ArrowRight size={12} className="mr-2 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all md:w-3.5 md:h-3.5" />
                    {item}
                  </a>
                </li>
          ...
          <div className="hidden lg:block">
            <h4 className="text-white font-black uppercase tracking-[0.2em] text-[10px] md:text-xs mb-6 md:mb-8">লিঙ্কসমূহ</h4>
            <ul className="flex flex-col gap-3 md:gap-4">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start gap-1">
            <p className="text-[8px] md:text-[10px] font-black text-white/20 uppercase tracking-[0.2em] md:tracking-[0.3em] text-center md:text-left">
          ...
          <div className="flex items-center gap-5 md:gap-8 grayscale opacity-30 hover:opacity-100 hover:grayscale-0 transition-all duration-700">
            ...
            <div className="h-4 md:h-6 w-px bg-white/10 hidden md:block" />
            <div className="flex gap-3 md:gap-4">
               {/* Payment Icons Placeholder */}
               <div className="w-8 md:w-10 h-5 md:h-6 bg-white/5 rounded border border-white/10" />
               <div className="w-8 md:w-10 h-5 md:h-6 bg-white/5 rounded border border-white/10" />
               <div className="w-8 md:w-10 h-5 md:h-6 bg-white/5 rounded border border-white/10" />
            </div>
          </div>
